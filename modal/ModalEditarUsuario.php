<div class="modal fade" id="ModalEditarUsuario<?php echo $mostrar['id'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form id="FormularioEditarUsuario">
          ...
          <div class="row">
            <div class="col-3">
              ...
              <input type="text" class="form-control" id="nombre" value="<?php echo $almacen_datos_usuarios_creados['Usuario']?>"  minlength="2" maxlength="8" disabled>
            </div>
            <div class="col-3">
              <label for="recipient-name" class="col-form-label fw-semibold">Contraseña:</label>
              <input type="text" class="form-control" id="mesa" value="<?php echo $almacen_datos_usuarios_creados['Contraseña']?>"  minlength="2" maxlength="8" disabled>
            </div>
