...
// var hoy = moment();
// // var hoyformato = hoy.format("DD-MM-YYYY");

// var diacorte = moment().add(7 , 'days');

// console.log(hoy.format("DD-MM-YYYY"))
// console.log(diacorte.format("DD-MM-YYYY"))
    ...
    $.post('../funcionalidad/Consulta_Modal_Resuscribir.php', Datos, function(
        respuesta) { // metodo post del query igualmente funcional que el anterior
...
$(document).on('click', '.btnInformacion', function() {
    ...
    $.post('../funcionalidad/Consulta_InformacionAdicional.php', Datos, function(
        respuesta) { // metodo post del query igualmente funcional que el anterior
            ...
            json.forEach(json => { //Se asignan los valores obtendios en json a su respectivo input
                ...
                if($icono == 's'){
                    document.getElementById("icono").innerHTML = '<i class="bi bi-check-circle" style="font-size: 2em; color: green;"></i>';
                }else{
                    document.getElementById("icono").innerHTML = '<i class="bi bi-x-circle" style="font-size: 2em; color: red;"></i>';
                }
...
$(document).on('click', '.btnReiniciarUsuarioMk', function() {
    ...
    $.post('../funcionalidad/ResetearUsersMikrotik.php', Datos, function(
        respuesta) { // metodo post del query igualmente funcional que el anterior
            console.log(respuesta);
            let json = JSON.parse(respuesta); //Almacena el resultado del json en el let json
            json.forEach(json => { //Se asignan los valores obtendios en json a su respectivo input
...
$(document).on('click', '.btnDesconectarUsuarioMK', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.post('../funcionalidad/DesconectarUsuarioDelMikrotik.php', Datos, function(
                    respuesta) { // metodo post del query igualmente funcional que el anterior
...
$('#FormularioReSuscribirUsuario').submit(function(e) {
    ...
    $.post('../funcionalidad/ReSuscribirUsuario.php', Datos, function(
        respuesta) { // metodo post del query igualmente funcional que el anterior
...
$('#FormularioCrearUsuarioAleatorio').submit(function(e) {
    ...
    $.post('../funcionalidad/UsuariosAleatorios.php', Datos, function(
        respuesta) { // metodo post del query igualmente funcional que el anterior
    ...
    if($('#N_usuario').val() != "" && $('#N_contra').val() != ""){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                console.log(Datos)
                $.post('../funcionalidad/EliminarUsuarioCreado.php', Datos, function(
                    respuesta) { // metodo post del query igualmente funcional que el anterior
...
console.log(Datos);
    $.post('../funcionalidad/AgregarPago.php', Datos, function(
        respuesta) { // metodo post del query igualmente funcional que el anterior
...
$('#FormularioAgregarUsuario').submit(function(e) {
    ...
    $.post('../funcionalidad/SuscribirUsuarioNuevo.php', Datos, function(
        respuesta) { // metodo post del query igualmente funcional que el anterior
